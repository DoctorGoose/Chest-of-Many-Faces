...
class NpcGenerator():
    ...
    def race_gen(self):  # races are biased towards the earlier part of the list, as these are more prevalent races in major cities
        races = ["Human", "Elf", "Half-Elf", "Tiefling", "Halfling", "Dragonborn", "Drow", "Changeling"]
        self.race = choice(races, 1, p=[0.40, 0.25, 0.10, 0.10, 0.05, 0.05, 0.04, 0.01])
        
    def sex_gen(self):
        sexes = ["Male", "Female"]
        self.sex = choice(sexes, 1, p=[0.50, 0.50])
        
    def name_gen(self):
        if self.race == "Human":
            if self.sex == "Male":
                with open("lib/names/male human names.txt", "r") as names:  # All names are saved in txt docs locally to save processing power and document space to exponentially increase num of options
                ...
                with open("lib/names/female human names.txt", "r") as names:
            ...
            if self.sex == "Male":
                with open ("lib/names/male elf names.txt", "r") as names:
                ...
                with open ("lib/names/female elf names.txt", "r") as names:
            ...
            if self.sex == "Male":
                with open("lib/names/male dwarf names.txt", "r") as names:
                ...
                with open("lib/names/female dwarf names.txt", "r") as names:
            ...
            if self.sex == "Male":
                with open("lib/names/male half elf names.txt", "r") as names:
                ...
                with open("lib/names/female half elf names.txt", "r") as names:
            ...
            if self.sex == "Male":
                with open("lib/names/male tiefling names.txt", "r") as names:
                ...
                with open("lib/names/female tiefling names.txt", "r") as names:
            ...
            if self.sex == "Male":
                with open("lib/names/male halfling names.txt", "r") as names:
                ...
                with open("lib/names/female halfling names.txt", "r") as names:
            ...
            if self.sex == "Male":
                with open("lib/names/male half orc names.txt", "r") as names:
                ...
                with open("lib/names/female half orc names.txt", "r") as names:
            ...
            if self.sex == "Male":
                with open("lib/names/male dragonborn names.txt", "r") as names:
                ...
                with open("lib/names/female dragonborn names.txt", "r") as names:
            ...
            if self.sex == "Male":
                with open("lib/names/male gnome names.txt", "r") as names:
                ...
                with open("lib/names/female gnome names.txt", "r") as names:
            ...
            if self.sex == "Male":
                with open("lib/names/male goblin names.txt", "r") as names:
                ...
                with open("lib/names/female goblin names.txt", "r") as names:
            ...
            if self.sex == "Male":
                with open("lib/names/male hobgoblin names.txt", "r") as names:
                ...
                with open("lib/names/female hobgoblin names.txt", "r") as names:
            ...
            if self.sex == "Male":
                with open("lib/names/male drow names.txt", "r") as names:
                ...
                with open("lib/names/female drow names.txt", "r") as names:
            ...
            if self.sex == "Male":
                with open("lib/names/male satyr names.txt", "r") as names:
                ...
                with open("lib/names/female satyr names.txt", "r") as names:
            ...
            with open("lib/names/male human names.txt", "r") as names:  # Changelings are intentionally left sexless due to their mutable form
    ...
    def flaw_gen(self):
        with open("lib/personalityelements/Flaws.txt", "r") as flaws:
    ...
    def bond_gen(self):
        with open("lib/personalityelements/Bonds.txt", "r") as bonds:
    ...
    def personality_gen(self):
        with open("lib/personalityelements/Personality Traits.txt", "r") as ptraits:
    ...
    def ideal_gen(self):
        with open("lib/personalityelements/Ideals.txt", "r") as ideals:
    ...
    def quirk_gen(self):
        with open("lib/personalityelements/Quirks.txt", "r") as quirks:
    ...
    def physical_gen(self):
        with open("lib/personalityelements/Physical Traits.txt", "r") as physicals:
